...
def generate_launch_description():
    ...
    gazebo = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            FindPackageShare("gazebo"), '/launch', '/gazebo_launch.py'
        ]),
    ...
    robot_spawn = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            FindPackageShare("gazebo"), '/launch', '/robot_spawn_launch.py'
        ]),
        launch_arguments={'world_select': world_select_val}.items()
    )
    ...
    ros2_control = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            FindPackageShare("gazebo"), '/launch', '/ros2_control_launch.py'
        ])
    )
